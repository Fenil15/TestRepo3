...
The primary theme color is blue (#1976D2). The tab text in the tab bar is light gray (#B0B0B0) across default, hover/focus, and active states.
...
- Confirm the app's primary theme accents use blue (#1976D2) consistently.
